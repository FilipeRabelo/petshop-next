...
//       console.log('Dados da cotação:', response.data.USDBRL); // Log para depuração
//     } catch (error) {
...
//           {currency ? (
//             <p>
//               R$ {currency.bid} (Atualizado em: {moment(currency.create_date, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss')})
//             </p>
//           ) : (
...
const WeatherAndCurrency = () => {
  ...
  return (
    <div className="px-20 mb-10 bg-[#E84C3D]">
      ...
      <div className="flex justify-center mt-6" data-aos="fade-left" data-aos-duration="3000">
        <button
          onClick={updateAll}
          disabled={isUpdating}
